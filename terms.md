...
InnerRing does not provide public user discovery. Contacts are created through invite codes. You are responsible for choosing who you invite and communicate with.

## 5. Acceptable Use

You agree not to use InnerRing to:
...
Some features, including contacts, invites, and messaging, may require an active subscription.

Subscriptions are purchased through Apple's App Store and are managed by Apple. Billing, cancellation, refunds, and renewal behavior are governed by Apple's terms and App Store rules.
...
You are responsible for the content you send through InnerRing.
