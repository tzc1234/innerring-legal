...
Be careful when opening links sent in messages. Links may lead outside InnerRing and may be used for scams, impersonation, payment fraud, malware, or recovery-key theft.

Never share your recovery key with anyone. InnerRing will not ask you to send your recovery key in a message or through an external link.

## Urgent Safety

InnerRing is not an emergency service. If you or someone else is in immediate danger, contact local emergency services.
...
- Provide public user discovery.
- Provide group chat, public feeds, or public posting.
- Use phone numbers or email addresses for account identity.
- Routinely scan ordinary encrypted message contents.
- Act as the communication medium between reported users and authorities.

InnerRing may preserve records, submit legally required reports, and follow competent-authority instructions where required.
